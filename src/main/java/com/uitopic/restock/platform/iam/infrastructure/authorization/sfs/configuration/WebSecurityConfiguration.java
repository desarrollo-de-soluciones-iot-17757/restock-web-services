    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/anomalies/**", "/api/v1/telemetries/**", "/api/v1/telemetry-readings/**", "/api/v1/devices-health/**", "/api/v1/tracking/metrics/**", "/api/v1/tracking/anomalies/**", "/api/v1/devices/status/**").permitAll()
