 ...
 */
@ReadingConverter
public class DiscrepancyLevelReadConverter implements Converter<String, DiscrepancyLevel> {
     ...
     */
    @Override
    public DiscrepancyLevel convert(String source) {
        if (source == null) return null;
        try {
            return DiscrepancyLevel.valueOf(source);
        } catch (Exception e) {
