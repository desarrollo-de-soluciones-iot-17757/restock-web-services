...
/**
 * Global exception handler for REST controllers, providing centralized handling of common exceptions.
 * <p>
 * This class uses Spring's {@link ControllerAdvice} to intercept exceptions thrown by any controller and return consistent HTTP responses with appropriate status codes and error messages.
 * <p>
 */
@ControllerAdvice
public class GlobalExceptionHandler {
    ...
    /**
     * Handles {@link InvalidCredentialsException}, thrown when authentication fails due to invalid credentials.
     *
     * @param ex the exception containing a message about the authentication failure
     * @return a {@link ResponseEntity} with HTTP 401 status and the error message indicating invalid credentials
     */
